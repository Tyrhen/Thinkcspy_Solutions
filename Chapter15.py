...
class SMS_store(object):
    ...
    def add_new_arrival(self, from_number,time_arrived, text_of_SMS, has_been_viewed = False):
        ...
        return self.messages.append((self.has_been_viewed, self.from_number,self.time_arrived,
                                     self.text_of_SMS))
...
def test_suite():
    ...
    test(inbox.messages == [(754745774,'10:32AM','text 1')])
    ...
    print('\n P6.2 get_unread')
    test(inbox.get_unread_indexes() ==
         [(False, 754745774,'10:32AM','text 1'), (False, 754745775,'10:42PM','text 2')])
    ...
    print('\n P6.4 delete_message')
    test(inbox.delete(1) == [(False, 754745774,'10:32AM','text 1'),(True, 754745775,'10:43PM','text 3')])
